        ...
        <div className="flex items-center gap-2">
          ...
          <div className="group relative">
            <Link
              ...
              className="interactive-control relative flex rounded-lg p-2 text-[#444444] transition-colors hover:bg-comfort-hover hover:text-ink-900 focus:outline-none focus-visible:bg-comfort-hover focus-visible:text-ink-900"
            >
            ...
            <div className="invisible absolute right-0 top-full w-80 pt-3 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
              <div className="flex max-h-[28rem] flex-col overflow-hidden rounded-xl border border-surface-200 bg-comfort text-ink-800 shadow-xl shadow-ink-900/15">
                  ...
                  <div className="overflow-y-auto py-1">
                    {openAlerts.slice(0, 6).map((item) => (
                      <Link
                        key={item.id}
                        href="/notifications"
                        className="interactive-control block border-b border-surface-100 px-4 py-3 last:border-0 transition-colors hover:bg-comfort-hover focus:outline-none focus-visible:bg-comfort-hover"
                      >
                ...
                <Link
                  href="/notifications"
                  className="interactive-control mt-auto flex items-center justify-between border-t border-surface-200 bg-comfort-hover px-4 py-3 text-xs font-semibold text-ink-700 transition-colors hover:bg-comfort-strong hover:text-ink-900 focus:outline-none focus-visible:bg-comfort-strong"
                >
